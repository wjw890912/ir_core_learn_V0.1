...
/*   In automatic slave select operation, call this function to select the slave select pin. The state of  */
/*   slave select pin will be controlled by hardware.                                                      */
...
/*                                                                                                         */
/* Description:                                                                                            */
/*    Set the slave select pin to inactive state. Only for master mode.                                    */
/*---------------------------------------------------------------------------------------------------------*/
